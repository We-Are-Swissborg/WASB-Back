...
const createCategory = async (req: Request, res: Response) => {
    ...
    try {
        const category = plainToClass(PostCategory, req.body as string, { groups: ['author'] });
...
const getCategories = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const categoriesDTO = instanceToPlain(categories, { groups: ['author'], excludeExtraneousValues: true });
...
const getCategory = async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (category instanceof PostCategory) {
            const categoryDTO = instanceToPlain(category, { groups: ['author'], excludeExtraneousValues: true });
